...
def create_graph_documents(texts, subjects, cc, froms, tos, dates, times, llm_transformer):
    ...
    for text in tqdm(texts, desc="Converting texts to graph documents"):
        graph_document = llm_transformer.convert_to_graph_documents([text])
        graph_documents.extend(graph_document)
    
    for i, g in tqdm(enumerate(graph_documents), total=len(graph_documents), desc="Creating graph documents"):
